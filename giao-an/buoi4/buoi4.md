...
1.  **Hoàn thiện Landing Page (Responsive):**
    -   Áp dụng Responsive cho bài tập về nhà Buổi 1.
    -   Đảm bảo hiển thị đẹp trên cả điện thoại và máy tính.
2.  **Tìm hiểu trước:** Khái niệm `State` trong React là gì? Tại sao biến thường không làm thay đổi giao diện?
